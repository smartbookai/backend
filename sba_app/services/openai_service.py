...
BASE_PROMPT_PAYROLL = (
    ...
    "- SS EMPRESA: Buscar en la tabla inferior 'DETERMINACIÓN DE LAS BASES' columna 'APORTACIÓN EMPRESARIAL'. SUMAR TODAS las líneas:\n"
    "  * Contingencias comunes (ej: 235.62)\n"
    "  * MEI - Mecanismo Equidad Intergeneracional (ej: 6.69)\n"
    "  * AT y EP - Accidentes de trabajo (ej: 35.95)\n"
    "  * Desempleo (ej: 54.91)\n"
    "  * Formación Profesional (ej: 5.99)\n"
    "  * Fondo Garantía Salarial (ej: 2.00)\n"
    "  SUMA TODOS estos valores. NO usar 'COSTE EMPRESA' que incluye salario + aportaciones\n\n"
    ...
    "    \"irpf\": \"0.00\" (buscar en DEDUCCIONES > IRPF o Impuesto sobre la renta o Tributación),\n"
