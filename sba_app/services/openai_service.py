...
PURCHASE_INVOICE_PROMPT = (
    ...
    "Esta es una FACTURA RECIBIDA. El PROVEEDOR (supplier) es quien EMITE la factura.\n\n"
    "En facturas españolas el EMISOR suele estar en la ESQUINA SUPERIOR IZQUIERDA:\n"
    "- Busca el nombre de empresa que aparece PRIMERO en el documento\n"
    "- Suele estar bajo el logo o en la parte superior\n"
    "- Incluye el CIF/NIF del emisor\n"
    "- Puede tener palabras como 'DATOS FISCALES', 'EMISOR'\n\n"
    "⚠️ NO CONFUNDIR CON:\n"
    "- 'DIRECCIÓN DE ENVÍO' o 'DATOS DE ENVÍO' (es el cliente)\n"
    "- 'DIRECCIÓN POSTAL' (es el cliente)\n"
    "- 'DESTINATARIO' o 'CLIENTE' (es el cliente)\n"
    "- Empresas que aparecen en el centro o derecha del documento\n\n"
    "EJEMPLO VISUAL:\n"
    "┌─────────────────────┐\n"
    "│ CERVINTER MALAGA    │ ← ESTE es el PROVEEDOR (supplier)\n"
    "│ CIF: XXXXXXXXX      │\n"
    "│ Málaga              │\n"
    "│                     │\n"
    "│ FACTURA Nº: XXX     │\n"
    "│                     │\n"
    "│ DIRECCIÓN DE ENVÍO: │\n"
    "│ MESONSEGALERVA SL   │ ← ESTE NO es el proveedor (es el cliente)\n"
    "│ Málaga              │\n"
    "└─────────────────────┘\n\n"
    "REGLA DE ORO: El proveedor es quien aparece PRIMERO/ARRIBA, NO quien aparece en 'Dirección de envío'\n\n"
    "IMPORTANTE:\n"
