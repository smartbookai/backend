...
PURCHASE_INVOICE_PROMPT = (
    ...
    "  ]\n"
    "}\n\n"
    "🔴 CRÍTICO - IDENTIFICACIÓN DEL PROVEEDOR:\n"
    "Esta es una FACTURA RECIBIDA. El PROVEEDOR (supplier) es quien EMITE/COBRA la factura.\n\n"
    "ALGORITMO DE IDENTIFICACIÓN:\n"
    "1. Busca el PRIMER nombre de empresa que aparece en el documento\n"
    "2. Este suele estar en la ESQUINA SUPERIOR IZQUIERDA\n"
    "3. Suele aparecer ANTES de la palabra 'FACTURA' o 'ABONO'\n"
    "4. Suele tener un logo o estar en letra grande\n"
    "5. Su CIF/NIF aparece CERCA de su nombre (arriba)\n\n"
    "⚠️ IGNORAR COMPLETAMENTE:\n"
    "- Cualquier empresa bajo 'DATOS DE ENVÍO'\n"
    "- Cualquier empresa bajo 'DIRECCIÓN POSTAL'\n"
    "- Cualquier empresa bajo 'DESTINATARIO'\n"
    "- Cualquier empresa bajo 'CLIENTE'\n"
    "- Cualquier empresa en el CENTRO o DERECHA del documento\n"
    "- Cualquier empresa cuyo CIF/NIF está LEJOS de la esquina superior izquierda\n\n"
    "PALABRAS CLAVE DE EMISOR (usar estas empresas):\n"
    "- Si ves 'CERVINTER' → ES EL PROVEEDOR\n"
    "- Si ves una empresa en la parte superior con CIF cerca → ES EL PROVEEDOR\n"
    "- Si aparece ANTES de 'FACTURA Nº' → ES EL PROVEEDOR\n\n"
    "PALABRAS CLAVE DE CLIENTE (NO usar estas empresas):\n"
    "- Si ves 'DATOS DE ENVÍO' cerca → NO ES EL PROVEEDOR\n"
    "- Si ves 'MESON SEGALERVA' bajo 'DATOS DE ENVÍO' → NO ES EL PROVEEDOR\n"
    "- Si ves 'Empresa' como encabezado → probablemente NO ES EL PROVEEDOR\n\n"
    "REGLA DEFINITIVA:\n"
    "El proveedor SIEMPRE es la primera empresa mencionada en el documento,\n"
    "típicamente en la esquina superior izquierda, NUNCA bajo 'DATOS DE ENVÍO'.\n\n"
    "IMPORTANTE:\n"
